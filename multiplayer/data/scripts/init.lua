--[[
Things the multiplayer mod modify:
- replace GameTriggerGameOver() from OnPlayerDied with a check that verifies all players are dead
]]--
...
-- Mod function
function OnPlayerDied( player_entity ) -- Game over is triggered in the mod's main instead
	GameDestroyInventoryItems( player_entity ) -- Try to find how to drop items on ground
